...
function parseTime(value) {
    ...
    let time = String(value).trim().toLowerCase();
...
function calculateAttendance(
    ...
    if (
        ...
        return {
            valid: false,
            message:
                "Please enter valid attendance times."
        };
    }
